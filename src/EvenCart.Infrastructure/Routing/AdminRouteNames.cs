...
namespace EvenCart.Infrastructure.Routing
{
    public static class AdminRouteNames
    {
        ...
        public const string ProductSpecificationsList = "ProductSpecificationsList";
        public const string ProductSpecificationsListByGroup = "ProductSpecificationsListByGroup";
        public const string EditProductSpecification = "EditProductSpecification";
        public const string EditProductSpecificationGroup = "EditProductSpecificationGroup";
        public const string DeleteProductSpecification = "DeleteProductSpecification";
        ...
        public const string EditProductRelation = "EditProductRelation";
        public const string DeleteProductRelation = "DeleteProductRelation";
        ...
        public const string DeleteStore = "DeleteStore";
        public const string SaveStore = "SaveStore";
        public const string CloneStore = "CloneStore";

        public const string CatalogsList = "CatalogsList";
        public const string GetCatalog = "GetCatalog";
        public const string DeleteCatalog = "DeleteCatalog";
        public const string SaveCatalog = "SaveCatalog";
    }
}