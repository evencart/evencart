...
{
    public class CategoryService : GenesisEntityService<Category>, ICategoryService
    {
        ...
        public override void Delete(Category entity, Transaction transaction = null)
        {
            ...
            CacheProvider.Remove(CategoryTreeCacheKey);
        }

        public override void Insert(Category entity, Transaction transaction = null)
        {
