...
namespace Shipping.UPS
{
    public class ProviderImpl
    {
        ...
        public ProviderImpl(string licenseNumber, string userId, string password) : this(licenseNumber, userId, password, DEFAULT_TIMEOUT)
        {
        }

        public ProviderImpl(string licenseNumber, string userId, string password, int timeout)
        {
            Name = "UPS";
        ...
        public ProviderImpl(string licenseNumber, string userId, string password, string serviceDescription)
        {
            Name = "UPS";
            _licenseNumber = licenseNumber;
            _userId = userId;
        ...
        public ProviderImpl(string licenseNumber, string userId, string password, int timeout, string serviceDescription)
        {
            Name = "UPS";
            _licenseNumber = licenseNumber;
            _userId = userId;
        ...
        public ProviderImpl(string licenseNumber, string userId, string password, int timeout, string serviceDescription, string shipperNumber)
        {
            Name = "UPS";
            _licenseNumber = licenseNumber;
            _userId = userId;
        ...
        private byte[] BuildRatesRequestMessage()
        {
            ...
            writer.WriteElementString("PostalCode", Shipment..PostalCode);
