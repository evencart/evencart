(function (global, factory) {
    ...
    Navigo.prototype = {
        ...
        navigate: function navigate(path, absolute, skipHistory) {
            var to;
        ...
        resolve: function resolve(current) {
            ...
            if (m) {
                ...
                manageHooks(function () {
                    manageHooks(function () {
                        m.route.route instanceof RegExp ? handler.apply(undefined, m.match.slice(1, m.match.length)) : handler(m.route.route, m.params, GETParameters);
