...
namespace RoastedMarketplace.Core.Modules
{
    public class ModuleConfigurator
    {
        ...
        public static void WriteConfigFile(IList<ModuleInfo> modules, string configFilePath)
        {
        ...
        public static ModuleInfo LoadModuleInfo(string fileName)
        {
                        ...
                        if (currentConfigName != string.Empty)
                        {
                            ...
                            switch (currentConfigName)
                            {
                                ...
                                case "authoruri":
                                    ...
                                    break;
                                case "moduleuri":
                                    moduleInfo.ModuleUri = value;
                                    break;
                                case "assemblydllname":
                                    moduleInfo.AssemblyDllName = value;
                                    break;
                                case "issystemmodule":
                                    moduleInfo.IsSystemModule = Convert.ToBoolean(value);
                                    break;
                            }
                        }
                        break;
            ...
            {
                var assemblyFilePath = Path.Combine(fileInfo.DirectoryName, moduleInfo.AssemblyDllName);
        ...
        public static ModuleInfo LoadModuleInfo(IModule module)
        {
            var moduleInfo = new ModuleInfo()
            {
        ...
        public static IEnumerable<ModuleInfo> GetAllModulesInfos(DirectoryInfo probeDirectory, IList<ReadModuleInfo> readModules)
        {
