...
namespace RoastedMarketplace.Services.Extensions
{
    public static class PaymentProcessorExtensions
    {
        ...
        {
            if (request == null)
                throw new RoastedMarketplaceException("Can't read a null request");
        ...
        {
            if(result == null)
                throw new RoastedMarketplaceException("Can't read a null result");
            ...
            object parameterValue)
        {
            if(paymentTransaction == null)
                throw new RoastedMarketplaceException("Can't read null payment transaction");
