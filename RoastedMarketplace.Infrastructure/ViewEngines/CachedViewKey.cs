...
namespace RoastedMarketplace.Infrastructure.ViewEngines
{
    public class CachedViewKey : IEquatable<CachedViewKey>
    {
        ...
        {
            return string.Equals(ViewPath, other.ViewPath) && string.Equals(Url, other.Url) && string.Equals(LanguageCultureCode, other.LanguageCultureCode);
        }
        ...
        public static CachedViewKey Get(string viewPath, string languageCultureCode)
        {
            ...
            if (viewPath.Contains("/"))
            {
                ...
                if (viewPathParts.Length > 1)
                {
                    ...
                    var route = RouteFinder.GetAllRoutes(controller)
